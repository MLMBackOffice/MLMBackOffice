...
<header>
	<div class="perfil left-align">
		<div class="imagen-perfil"><?php echo Html::img('@web/images/perfil.png') ?></div>
		<div class="texto-perfil"><p>
                          <?php if($patr) echo "Has sido invitado por ".$patr?>
                    </p></div>
	</div>
</header>
...
<div class="container">
	...
	<div class="row">
		<div class="botones center-align">
			<a href="<?php echo Url::to(['user/register?pat='.$patr]); ?>" target="_blank"><button class="btn waves-effect waves-light" type="submit" name="action">Registrarme
